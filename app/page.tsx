  ...
  return (
    <div className="flex flex-col w-full items-center justify-center">
      ...
      <div className="relative flex items-center h-[max(100svh,941px)] w-full">
        ...
        <div className="absolute top-[37%] left-[100px] max-w-[650px] max-ipad:w-[50%]">
      ...
      <div className="relative flex items-center h-[max(100svh,941px)] w-full">
        ...
        <div className="absolute right-[100px] top-[13%] max-w-[590px] max-ipad:w-[50%]">
      ...
      <div className="relative flex items-center h-[max(100svh,941px)] w-full">
        ...
        <div className="absolute top-[13%] left-[100px] max-w-[650px] max-ipad:w-[50%]">
      ...
      <div className="relative flex items-center h-[max(100svh,941px)] w-full">
        ...
        <div className="absolute top-[13%] right-[100px] max-w-[650px] max-ipad:w-[50%]">
      ...
      <div className="relative flex items-center h-[max(100svh,941px)] w-full">
        ...
        <div className="absolute left-[100px] max-w-[650px] max-ipad:w-[50%]">
